...
public class DeleteNotes
{
    ...
    public List<Boolean> consultants_notes_delete(String reference, List<Boolean> results)
    {
        finished = false;
        ParseQuery<ParseObject> query = ParseQuery.getQuery("Notes");
        query.whereEqualTo("Parent", reference);
    ...
    public List<Boolean> specifications_notes_delete(String reference, List<Boolean> results)
    {
        finished = false;
        ParseQuery<ParseObject> query = ParseQuery.getQuery("Notes");
        query.whereEqualTo("Parent", reference);
