...
public class DeleteFiles
{
    ...
    public List<Boolean> consultants_files_delete(String reference, List<Boolean> results)
    {
        finished = false;
        ParseQuery<ParseObject> query = ParseQuery.getQuery("PDFFiles");
        query.whereEqualTo("Parent", reference);
    ...
    public List<Boolean> specifications_files_delete(String reference, List<Boolean> results)
    {
        finished = false;
        ParseQuery<ParseObject> query = ParseQuery.getQuery("PDFFiles");
        query.whereEqualTo("Parent", reference);
