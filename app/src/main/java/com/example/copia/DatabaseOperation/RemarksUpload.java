...
public class RemarksUpload
{
    ...
    public boolean consultants_remarks_upload(List<Label> remarksList, final ParseObject reference)
    {
        ArrayList<Boolean> results = new ArrayList<>();
        if(remarksList.size() > 0)
        {
    ...
    public boolean specifications_remarks_upload(List<Label> remarksList, final ParseObject reference)
    {
        ArrayList<Boolean> results = new ArrayList<>();
        if(remarksList.size() > 0)
        {
